...
['learn','fix'].forEach(m=>$(m+'-mode').onclick=()=>{if(animating||planning)return;state.mode=m;view.reset();$('move-caption').textContent=m==='fix'?'Hold yellow on top and green in front.':'Tap a face to turn it. Drag to change your view.';render();});
